...
| `加入排行榜 <QQ号/@用户> [群号]` | 为指定用户加入指定群的排行榜（仅超管可执行） |
| `退出排行榜 <QQ号/@用户> [群号]` | 为指定用户退出指定群的排行榜（仅超管可执行） |

### 用户命令

| 命令 | 说明 |
|------|------|
| `加入排行榜 [QQ号/@用户] [群号]` | 加入指定群的排行榜（支持@用户，群号不填默认为当前群，指定群操作仅超管可执行）|
| `退出排行榜 [QQ号/@用户] [群号]` | 退出指定群的排行榜（支持@用户，群号不填默认为当前群，指定群操作仅超管可执行）|
